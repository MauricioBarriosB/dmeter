        ...
        <Card>
            <CardHeader className="flex justify-between items-center">
                ...
                <ConfirmDialog
                    ...
                    message="Are you sure you want to delete all materials reports? This action cannot be undone."
                ...
                <ConfirmDialog
                    ...
                    message="Are you sure you want to delete this materials report? This action cannot be undone."
                    confirmText="Delete"
