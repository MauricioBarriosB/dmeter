...
import { ArrowLeft, Volume2, Mic, BarChart2, Zap } from "lucide-react";
...
import { fetchAnalysisReport } from "@services/apiCrud";
...
} from "@modules/audio/helpers/spectrumPeaksHelper";
import UnauthorizedAlert from "@components/UnauthorizedAlert";
import FrequencyPeaksTable from "../components/FrequencyPeaksTable";
import FrequencyResponseCard from "@modules/audio/components/FrequencyResponseCard";
import {
...
} from "@/modules/meter/helpers/advancedMetrics";

export default function DetailMeter() {
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-8">
                ...
                <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                        ...
                        <p className="text-lg text-default-500">Analysis Report</p>
                    </div>
                </div>
                ...
                <CardBody>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                        <div>
                            ...
                            <p className="text-2xl font-semibold">{formatDuration(record.duration)}</p>
                        </div>
                        <div>
            ...
            {record.spectrumPeaks && record.spectrumPeaks.length > 0 && (
                <FrequencyResponseCard
                    octaveBands={paddedPeaks
                        .filter((p) => p.amplitude !== null)
                        .map((p) => ({ frequency: p.frequency, magnitude: p.amplitude as number }))}
                    thirdOctaveBands={[]}
                    spectrumData={[]}
                    height={300}
                ...
                <CardBody>
                    <div className="space-y-4">
                        <div>
                            ...
                            <Progress value={bandEnergy.low} color="danger" className="h-3" size="sm" />
                            <p className="text-xs text-default-400 mt-1 sm">
                        ...
                        <div>
                            ...
                            <Progress value={bandEnergy.mid} color="warning" className="h-3" size="sm" />
                        ...
                        <div>
                            ...
                            <Progress value={bandEnergy.high} color="success" className="h-3" size="sm" />
                        ...
                        <table className="w-full table-fixed">
                            <thead>
                                <tr className="border-b border-default-200">
                                    <th className="py-3 text-left text-sm font-semibold text-default-600 w-1/3">
                                        Detail
                                    </th>
                                    <th className="py-3 text-center text-sm font-semibold text-default-600 w-1/3">
                                        Amplitude/kHz
                                    </th>
                                    <th className="py-3 text-center text-sm font-semibold text-default-600 w-1/3">
                                        Level/kHz
                            ...
                            <tbody>
                                <tr className="border-b border-default-100">
                                    ...
                                    <td className="py-3 font-semibold text-center">{record.peakDb} dB</td>
                                    <td className="py-3">
                                        <Progress
                                            size="sm"
                                            value={Math.max(0, Math.min(100, ((record.peakDb + 60) / 60) * 100))}
                                            color="danger"
                                ...
                                <tr className="border-b border-default-100">
                                    ...
                                    <td className="py-3 font-semibold text-center">{record.avgDb} dB</td>
                                    <td className="py-3">
                                        <Progress
                                            size="sm"
                                            value={Math.max(0, Math.min(100, ((record.avgDb + 60) / 60) * 100))}
                                            color="primary"
                                            className="max-w-full"
                                        />
                                    </td>
                                ...
                                <tr className="border-b border-default-100">
                                    ...
                                    <td className="py-3 font-semibold text-center">{record.minDb} dB</td>
                                    <td className="py-3">
                                        <Progress
                                            size="sm"
                                            value={Math.max(0, Math.min(100, ((record.minDb + 60) / 60) * 100))}
                                            color="success"
                                            className="max-w-full"
                                        />
                                    </td>
                                ...
                                <tr className="border-b border-default-100">
                                    ...
                                    <td className="py-3 font-semibold text-center">{record.maxDb} dB</td>
                                    <td className="py-3">
                                        <Progress
                                            size="sm"
                                            value={Math.max(0, Math.min(100, ((record.maxDb + 60) / 60) * 100))}
                                            color="warning"
                                            className="max-w-full"
                                        />
                                    </td>
                                ...
                                <tr className="border-b border-default-100">
                                    ...
                                    <td className="py-3 font-semibold text-center">{crestFactor.toFixed(2)} dB</td>
                                    <td className="py-3">
                                        <Progress
                                            size="sm"
                                            value={Math.max(0, Math.min(100, (crestFactor / 20) * 100))}
                                            color="secondary"
                                            className="max-w-full"
                                        />
                                    </td>
                                ...
                                <tr className="border-b border-default-100">
                                    ...
                                    <td className="py-3 font-semibold text-center">{dynamicRange.toFixed(2)} dB</td>
                                    <td className="py-3">
                                        <Progress
                                            size="sm"
                                            value={Math.max(0, Math.min(100, (dynamicRange / 60) * 100))}
                                            color="warning"
                                            className="max-w-full"
                                        />
                                    </td>
                                ...
                                <tr className="border-b border-default-100">
                                    ...
                                    <td className="py-3">
                                        <Progress
                                            size="sm"
                                            value={Math.max(0, Math.min(100, (spectralCentroid / 10000) * 100))}
                                            color="primary"
                                            className="max-w-full"
                                        />
                                    </td>
                                ...
                                <tr className="border-b border-default-100">
                                    ...
                                    <td className="py-3">
                                        <Progress
                                            size="sm"
                                            value={Math.max(0, Math.min(100, (spectralRolloff / 20000) * 100))}
                                            color="secondary"
                                            className="max-w-full"
                                        />
                                    </td>
