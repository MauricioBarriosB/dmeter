...
import type { AnalysisRecord, FrequencyPeak } from "@modules/meter/types";
import { usePersistentAnalysisHistory } from "../hooks/usePersistentAnalysisHistory";
import { validateLicense, showUnauthorizedToast } from "@/services/licenseValidator";
import HowToUse from "../../../components/HowToUse";
import { calculateDecibels } from "@/modules/meter/helpers/decibelsHelper";
...
export default function Meter() {
    ...
    const { history, addRecord, deleteRecord, clearHistory } = usePersistentAnalysisHistory();
    ...
    return (
        <div className="max-w-7xl mx-auto">
            <div className="mb-10">
                ...
                <p className="text-lg text-default-600 font-normal pb-4">
                ...
                <p className="text-sm text-default-600 font-normal">
                    For best results: connect a calibrated measurement microphone, use headphones to prevent audio
                    feedback, minimize background noise in the room, place the microphone at the listening position, and
                    allow a few seconds for the signal to stabilize before recording. Using a dedicated audio interface
                    will provide more accurate and reliable measurements.
                </p>
                <HowToUse
                    title="How to Use Meter"
                    steps={[
                        {
                            number: 1,
                            title: "Start Analysis",
                            description: 'Press "Start Analysis", set a test name and begin recording.',
                        },
                        {
                            number: 2,
                            title: "While Recording",
                            description: "See live spectrum and real-time dB values updating as you capture audio.",
                        },
                        {
                            number: 3,
                            title: "Stop Recording",
                            description:
                                'Press "Stop" to end the session. You will be prompted to name and save your analysis.',
                        },
                        {
                            number: 4,
                            title: "View Results",
                            description: "Check the Analysis History table to review saved recordings and metrics.",
                        },
                    ]}
                />
            </div>
