...
import { formatFrequency, type PaddedPeak } from "@modules/audio/helpers/spectrumPeaksHelper";

interface SpectrumAnalyzerGraphicProps {
    paddedPeaks: PaddedPeak[];
}

export default function SpectrumAnalyzerGraphic({ paddedPeaks }: Readonly<SpectrumAnalyzerGraphicProps>) {
