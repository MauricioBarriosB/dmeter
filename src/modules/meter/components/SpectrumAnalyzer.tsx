...
const SpectrumAnalyzer = forwardRef<HTMLDivElement, SpectrumAnalyzerProps>(({ isAnalyzing, isValid }, ref) => {
    ...
    return (
        <Card className="mb-8">
            ...
            <CardBody>
                <div ref={ref} className="w-full rounded-lg overflow-hidden bg-black" style={{ minHeight: "300px" }}>
                    {!isAnalyzing && (
