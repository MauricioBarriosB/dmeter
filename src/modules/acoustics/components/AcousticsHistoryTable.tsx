...
export default function AcousticsHistoryTable({
    ...
    onClearHistory,
    onEditRecord,
}: Readonly<AcousticsHistoryTableProps>) {
        ...
        <Card>
            <CardHeader className="flex justify-between items-center">
                ...
                <ConfirmDialog
                    ...
                    message="Are you sure you want to delete all acoustics analysis records? This action cannot be undone."
                ...
                <ConfirmDialog
                    ...
                    message="Are you sure you want to delete this acoustics analysis record? This action cannot be undone."
                    confirmText="Delete"
                                ...
                                {history.map((record) => (
                                    <tr key={record.id} className="border-b border-default-100 hover:bg-default-50">
                                        ...
                                        <td className="p-3 text-sm">
                                            ...
                                            {Number.parseInt(record.occupancy) > 0 && `, ${record.occupancy} ppl`}
                                        </td>
                                        <td className="p-3">
