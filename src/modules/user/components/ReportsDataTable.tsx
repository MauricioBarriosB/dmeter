...
import { fetchAllReports, deleteReportByType } from "@services/apiCrud";

import type { UnifiedReport, PaginationInfo, AllReportsParams } from "../types";
        ...
        <div className="space-y-4">
            ...
            >
                <TableHeader>
                    ...
                    <TableColumn>
                        <button className="th-sort-btn" onClick={() => handleSort("type")}>
                            Type {renderSortIcon("type")}
                        </button>
                    </TableColumn>
                    <TableColumn>
                        <button className="th-sort-btn" onClick={() => handleSort("createdAt")}>
                            Date {renderSortIcon("createdAt")}
                        </button>
                    </TableColumn>
                    <TableColumn className="text-center text-medium text-white">Actions</TableColumn>
                </TableHeader>
                <TableBody
                    items={reports}
                    isLoading={isLoading}
