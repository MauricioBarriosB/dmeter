...
import { Home as HomeIcon, Mic, Waves, Drum, Container, Music4, Timer, LogIn, UserPlus } from "lucide-react";
...
type SelectedKey = "meter" | "acoustics" | "materials" | "instruments" | "audio" | "time" | null;
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-10">
                ...
                <ul className="text-lg text-default-600 font-normal list-disc ml-5 space-y-1">
                    ...
                    <li>
                        Calculate precise reverb and delay times synced to your DAW tempo with BPM-aware pre-delay, note
                        subdivisions, per-repeat decay analysis, and ready-to-use plugin presets for 30 track types and
                        13 time signatures.
                    </li>
                    <li>
                ...
                {isAuthenticated ? (
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-6">
                        ...
                        <Button
                            ...
                            size="lg"
                            variant="shadow"
                            className="font-semibold text-white text-lg px-8 w-full sm:w-auto bg-orange-500"
            ...
            >
                ...
                <AccordionItem
                    key="time"
                    aria-label="Time Calculator Features"
                    title={
                        <span className="flex items-center gap-2 text-xl font-bold">
