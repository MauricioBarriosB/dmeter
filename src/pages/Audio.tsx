...
import { loadAudioHistory, saveAudioHistory, type AudioRecord, isStorageValid } from "../helpers/audioStorage";
...
import AudioHistoryTable from "../components/audio/AudioHistoryTable";
...
export default function Audio() {
    ...
    const handleFormSubmit = (record: AudioRecord) => {
