...
import { loadMaterialsHistory, type MaterialsReportRecord, isStorageValid } from "../helpers/analysisStorage";
...
export default function DetailMaterials() {
    ...
    useEffect(() => {
        ...
        fetchFromApi<Record<string, MaterialProperties>>("materialData")
            .then((data) => {
