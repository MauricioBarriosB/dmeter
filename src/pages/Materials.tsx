...
import { Container, Play, HelpCircle } from "lucide-react";
import {
    Button,
    Card,
    CardBody,
...
import { type MaterialsReportRecord, isStorageValid } from "../helpers/analysisStorage";
...
export default function Materials() {
    ...
    useEffect(() => {
        ...
        fetchFromApi<MaterialsConfig>("materialsConfig")
            .then((data) => {
    ...
    if (isValid === false || storageValid === false) return <UnauthorizedAlert />;
