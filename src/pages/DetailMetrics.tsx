          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-4 bg-default-100 rounded-lg">
              <div className="flex justify-between items-center mb-2">
                ...
                <Chip color={brightness.color} size="sm">{brightness.label}</Chip>
              </div>
        ...
        <CardBody>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-default-400 mt-1">Bass frequencies - kick drums, bass instruments</p>
            </div>
            <div>
              <div className="flex justify-between mb-1">
              ...
              <p className="text-xs text-default-400 mt-1">Vocal range, most instruments, speech clarity</p>
            </div>
            <div>
              <div className="flex justify-between mb-1">
            ...
            <table className="w-full">
              <tbody>
                ...
                <tr className="border-b border-default-100">
                  ...
                  <td className="py-3 font-semibold text-right">{formatFrequency(Math.round(spectralCentroid))}</td>
                </tr>
                <tr className="border-b border-default-100">
                  <td className="py-3 text-default-500">Spectral Rolloff</td>
                  <td className="py-3 font-semibold text-right">{formatFrequency(Math.round(spectralRolloff))}</td>
                </tr>
                <tr>
                  <td className="py-3 text-default-500">Spectral Flatness</td>
                  <td className="py-3 font-semibold text-right">{(spectralFlatness * 100).toFixed(2)}%</td>
                </tr>
              </tbody>
            </table>
          </div>
