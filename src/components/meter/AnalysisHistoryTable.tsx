...
export default function AnalysisHistoryTable({
    ...
    onClearHistory,
    isValid,
}: Readonly<AnalysisHistoryTableProps>) {
        ...
        <Card>
            <CardHeader className="flex justify-between items-center">
                ...
                <ConfirmDialog
                    ...
                    message="Are you sure you want to delete all analysis records? This action cannot be undone."
            ...
            <CardBody>
                {history.length === 0 ? (
                    <p className="text-center text-default-500 py-8">
                        No analysis records yet. Start an analysis to create your first record.
                    </p>
                ) : (
