...
export default function Layout({ children }: Readonly<LayoutProps>) {
    ...
    // Combine nav items based on auth state — Contact is public hide from top on login
    const contactItem = { name: "Contact", href: "/contact", icon: Mail };
    const navItems = isAuthenticated ? [...publicNavItems, ...protectedNavItems] : [...publicNavItems, contactItem];
