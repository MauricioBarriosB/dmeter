...
import type { AudioRecord } from "../../helpers/audioStorage";
...
const getGenreColor = (genre: string): "primary" | "secondary" | "success" | "warning" | "danger" | "default" => {
...
const getMediaColor = (media: string): "primary" | "secondary" | "success" | "warning" | "danger" | "default" => {
    const colors: Record<string, "primary" | "secondary" | "success" | "warning" | "danger" | "default"> = {
        streaming: "success",
        spotify: "success",
        youtube: "danger",
