...
import type { TimeReportRecord } from "@modules/time/types";
import type { AllReportsParams, AllReportsResponse, ReportStats } from "@modules/user/types";
...
// ============================================================================
// TIME REPORTS (REVERB & DELAY)
// ============================================================================

export async function fetchTimeReports(): Promise<TimeReportRecord[]> {
    return apiRequest<TimeReportRecord[]>("time-reports");
}

export async function fetchTimeReport(id: string): Promise<TimeReportRecord> {
    return apiRequest<TimeReportRecord>(`time-reports/${id}`);
}

export async function createTimeReport(report: TimeReportRecord): Promise<TimeReportRecord> {
    return apiRequest<TimeReportRecord>("time-reports", "POST", report);
}

export async function updateTimeReport(id: string, report: TimeReportRecord): Promise<TimeReportRecord> {
    return apiRequest<TimeReportRecord>(`time-reports/${id}`, "PUT", report);
}

export async function deleteTimeReport(id: string): Promise<void> {
    await apiRequest<null>(`time-reports/${id}`, "DELETE");
}

export async function clearTimeReports(): Promise<void> {
    await apiRequest<null>("time-reports", "DELETE");
}
...
export async function fetchReportStats(): Promise<ReportStats> {
    return apiRequest<ReportStats>("report-stats");
}
